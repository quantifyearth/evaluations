...
shapefile_dir <- params$input_dir # path to directory in which the project shapefile is located
...
---
title: "`r paste0('4C Ex-Post Evaluation: ',(project_name %>% str_replace_all("_", " ") %>% str_to_title()))`"
---
...
shapefile <- read_sf(paste0(shapefile_dir,'/',project_name,'.geojson'))
...
country_map <- ne_countries(country = country_vec, returnclass = "sf")

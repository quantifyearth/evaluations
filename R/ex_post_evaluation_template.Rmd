...
input_dir <- params$input_dir # path to tmf-implementation inputs, i.e. the directory in which the project shapefile is located
tmf_output_dir <- params$output_dir # path to tmf-implementation output directory
...
# get shapefile from shapefile_path if supplied
# else use tmf input dir

if (!is.null(params$shapefile_path)) {
  shapefile_path <- c(params$shapefile_path)
